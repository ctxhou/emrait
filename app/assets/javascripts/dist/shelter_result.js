...
app.start();
},{"./collections/shelter":2,"./models/ambulance":3,"./views/shelter/shelter_modal":9,"./views/shelter/shelter_result":10,"backbone":15,"backbone.marionette":11,"bootstrap":16,"jquery":7,"spin":37,"underscore":38}],2:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
Backbone.$ = $;
