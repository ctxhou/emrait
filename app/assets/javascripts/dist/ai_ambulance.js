...
app.start();
},{"./models/ambulance":2,"./models/hospital":3,"./vendor/jQclock.min":5,"./vendor/jquery.tinyMap.min":8,"./vendor/readmore.min":9,"./views/ambulance/ambulance_modal":10,"backbone":15,"backbone.marionette":11,"bootstrap":16,"jquery":6,"underscore":37}],2:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
Backbone.$ = $;
