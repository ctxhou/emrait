...
app.start();
},{"./collections/emergencies":2,"./collections/hospital":3,"./models/ambulance":4,"./views/ambulance/ambulance_modal":11,"./views/emergency/show":12,"backbone":17,"backbone.marionette":13,"bootstrap":19,"jquery":9,"underscore":40}],2:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
Backbone.$ = $;
